...
void RenderDropdownTextItem(int index) {
    CLAY({ Clay_GetElementIdWithIndex(CLAY_STRING("ScrollContainerItem"), index), .layoutConfig = dropdownTextItemLayout, .rectangle = dropdownRectangleConfig }) {
...
Clay_RenderCommandArray CreateLayout() {
    Clay_BeginLayout();
    CLAY({ .id = Clay_GetElementId(CLAY_STRING("OuterContainer")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_GROW() }, .padding = { 16, 16 }, .childGap = 16 }, .rectangle = { .color = {200, 200, 200, 255} } }) {
        CLAY({ .id = Clay_GetElementId(CLAY_STRING("SideBar")), .layoutConfig = { .layoutDirection = CLAY_TOP_TO_BOTTOM, .sizing = { .width = CLAY_SIZING_FIXED(300), .height = CLAY_SIZING_GROW() }, .padding = {16, 16}, .childGap = 16 }, .rectangle = { .color = {150, 150, 255, 255} }}) {
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("ProfilePictureOuter")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW() }, .padding = { 8, 8 }, .childGap = 8, .childAlignment = { .y = CLAY_ALIGN_Y_CENTER } }, .rectangle = { .color = {130, 130, 255, 255} }}) {
                CLAY({ .id = Clay_GetElementId(CLAY_STRING("ProfilePicture")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(60), .height = CLAY_SIZING_FIXED(60) } }, .image = { .imageData = &profilePicture, .sourceDimensions = {60, 60} }}) {}
                CLAY_TEXT(profileText, CLAY_TEXT_CONFIG({ .fontSize = 24, .textColor = {0, 0, 0, 255} }));
            }
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("SidebarBlob1")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_FIXED(50) }}, .rectangle = { .color = {110, 110, 255, 255} }}) {}
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("SidebarBlob2")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_FIXED(50) }}, .rectangle = { .color = {110, 110, 255, 255} }}) {}
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("SidebarBlob3")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_FIXED(50) }}, .rectangle = { .color = {110, 110, 255, 255} }}) {}
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("SidebarBlob4")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_FIXED(50) }}, .rectangle = { .color = {110, 110, 255, 255} }}) {}
        }

        CLAY({ .id = Clay_GetElementId(CLAY_STRING("RightPanel")), .layoutConfig = { .layoutDirection = CLAY_TOP_TO_BOTTOM, .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_GROW() }, .childGap = 16 }}) {
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("HeaderBar")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW() }, .childAlignment = { .x = CLAY_ALIGN_X_RIGHT }, .padding = {8, 8}, .childGap = 8 }, .rectangle = { .color =  {180, 180, 180, 255} }}) {
            ...
            CLAY({
                .id = Clay_GetElementId(CLAY_STRING("MainContent")),
                .scroll = { .vertical = true },
                .layoutConfig = { .layoutDirection = CLAY_TOP_TO_BOTTOM, .padding = {16, 16}, .childGap = 16, .sizing = { CLAY_SIZING_GROW() } },
                .rectangle = { .color = {200, 200, 255, 255} }
            }){
                 CLAY({
                     .id = Clay_GetElementId(CLAY_STRING("FloatingContainer")),
                     .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(300), .height = CLAY_SIZING_FIXED(300) }, .padding = { 16, 16 }},
                 ...
                 CLAY({ .id = Clay_GetElementId(CLAY_STRING("Photos2")), .layoutConfig = { .childGap = 16, .padding = { 16, 16 }}, .rectangle = { .color = {180, 180, 220, 255} }}) {
                     CLAY({ .id = Clay_GetElementId(CLAY_STRING("Picture4")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(120), .height = CLAY_SIZING_FIXED(120) }}, .image = { .imageData = &profilePicture, .sourceDimensions = {120, 120} }}) {}
                     CLAY({ .id = Clay_GetElementId(CLAY_STRING("Picture5")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(120), .height = CLAY_SIZING_FIXED(120) }}, .image = { .imageData = &profilePicture, .sourceDimensions = {120, 120} }}) {}
                     CLAY({ .id = Clay_GetElementId(CLAY_STRING("Picture6")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(120), .height = CLAY_SIZING_FIXED(120) }}, .image = { .imageData = &profilePicture, .sourceDimensions = {120, 120} }}) {}
                 }
                 ...
                 CLAY({ .id = Clay_GetElementId(CLAY_STRING("Photos")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_GROW() }, .childAlignment = { .x = CLAY_ALIGN_X_CENTER, .y = CLAY_ALIGN_Y_CENTER }, .childGap = 16, .padding = {16, 16} }, .rectangle = { .color = {180, 180, 220, 255} }}) {
                     CLAY({ .id = Clay_GetElementId(CLAY_STRING("Picture2")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(120), .height = CLAY_SIZING_FIXED(120) }}, .image = { .imageData = &profilePicture, .sourceDimensions = {120, 120} }}) {}
                     CLAY({ .id = Clay_GetElementId(CLAY_STRING("Picture1")), .layoutConfig = { .childAlignment = { .x = CLAY_ALIGN_X_CENTER }, .layoutDirection = CLAY_TOP_TO_BOTTOM, .padding = {8, 8} }, .rectangle = { .color = {170, 170, 220, 255} }}) {
                         CLAY({ .id = Clay_GetElementId(CLAY_STRING("ProfilePicture2")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(60), .height = CLAY_SIZING_FIXED(60) }}, .image = { .imageData = &profilePicture, .sourceDimensions = {60, 60} }}) {}
                         CLAY_TEXT(CLAY_STRING("Image caption below"), CLAY_TEXT_CONFIG({ .fontSize = 24, .textColor = {0,0,0,255} }));
                     }
                     CLAY({ .id = Clay_GetElementId(CLAY_STRING("Picture3")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(120), .height = CLAY_SIZING_FIXED(120) }}, .image = { .imageData = &profilePicture, .sourceDimensions = {120, 120} }}) {}
                 }
        ...
        CLAY({ .id = Clay_GetElementId(CLAY_STRING("Blob4Floating2")), .floating = { .zIndex = 1, .parentId = Clay_GetElementId(CLAY_STRING("SidebarBlob4")).id }}) {
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("ScrollContainer")), .layoutConfig = { .sizing = { .height = CLAY_SIZING_FIXED(200) }, .childGap = 2 }, .scroll = { .vertical = true }}) {
                CLAY({ .id = Clay_GetElementId(CLAY_STRING("FloatingContainer2")), .floating = { .zIndex = 1 }}) {
                    CLAY({ .id = Clay_GetElementId(CLAY_STRING("FloatingContainerInner")), .layoutConfig = { .sizing = { .width = CLAY_SIZING_FIXED(300), .height = CLAY_SIZING_FIXED(300) }, .padding = {16, 16} }, .rectangle = { .color = {140,80, 200, 200} }}) {
                        CLAY_TEXT(CLAY_STRING("I'm an inline floating container."), CLAY_TEXT_CONFIG({ .fontSize = 24, .textColor = {255,255,255,255} }));
                    }
                }
                CLAY({ .id = Clay_GetElementId(CLAY_STRING("ScrollContainerInner")), .layoutConfig = { .layoutDirection = CLAY_TOP_TO_BOTTOM }, .rectangle = { .color = {160, 160, 160, 255} }}) {
                    for (int i = 0; i < 100; i++) {
        ...
        if (scrollData.found) {
            CLAY({ .id = Clay_GetElementId(CLAY_STRING("ScrollBar")),
                .floating = {
                ...
                CLAY({ .id = Clay_GetElementId(CLAY_STRING("ScrollBarButton")),
                    .layoutConfig = { .sizing = {CLAY_SIZING_FIXED(12), CLAY_SIZING_FIXED((scrollData.scrollContainerDimensions.height / scrollData.contentDimensions.height) * scrollData.scrollContainerDimensions.height) }},
