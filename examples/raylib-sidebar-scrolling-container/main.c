...
Clay_RenderCommandArray CreateLayout() {
    Clay_BeginLayout();
//    CLAY(CLAY_RECTANGLE(.color = {255,255,255,255}), CLAY_LAYOUT(.layoutDirection = CLAY_TOP_TO_BOTTOM, .sizing = { CLAY_SIZING_GROW() }, .childGap = 30)) {
//        CLAY(CLAY_RECTANGLE(.color = {200,255,255,255}), CLAY_LAYOUT(.sizing = { CLAY_SIZING_GROW() })) {
//            CLAY_TEXT(CLAY_STRING("hello"), CLAY_TEXT_CONFIG(.textColor = {255,255,255,255}, .fontSize = 30));
//        }
//        CLAY(CLAY_SCROLL(.vertical = true), CLAY_LAYOUT(.sizing = { .width = CLAY_SIZING_GROW() })) {
//            CLAY(CLAY_RECTANGLE(.color = {200,200,255,255}), CLAY_LAYOUT(.sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_FIXED(5000)})) {}
//        }
//    }
...
//
        CLAY(CLAY_ID("RightPanel"), CLAY_LAYOUT(.layoutDirection = CLAY_TOP_TO_BOTTOM, .sizing = { .width = CLAY_SIZING_GROW(), .height = CLAY_SIZING_GROW() }, .childGap = 16)) {
            ...
            CLAY(CLAY_ID("MainContent"),
                ...
                CLAY_LAYOUT(.layoutDirection = CLAY_TOP_TO_BOTTOM, .padding = {16, 16}, .childGap = 16, .sizing = { CLAY_SIZING_GROW(), CLAY_SIZING_GROW() }),
