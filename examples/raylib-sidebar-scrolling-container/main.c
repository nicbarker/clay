    ...
    CLAY(CLAY_ID("OuterContainer"), { .layout = { .sizing = { .width = CLAY_SIZING_GROW(0), .height = CLAY_SIZING_GROW(0) }, .padding = { 16, 16, 16, 16 }, .childGap = 16 }, .backgroundColor = {200, 200, 200, 255} }) {
        CLAY(CLAY_ID("SideBar"), { .layout = { .sizing = { .width = CLAY_SIZING_FIXED(300), .height = CLAY_SIZING_GROW(0) }, .padding = { 16, 16, 16, 16 }, .childGap = 16, .layoutDirection = CLAY_TOP_TO_BOTTOM }, .backgroundColor = {150, 150, 255, 255} }) {
            CLAY(CLAY_ID("ProfilePictureOuter"), { .layout = { .sizing = { .width = CLAY_SIZING_GROW(0) }, .padding = { 8, 8, 8, 8 }, .childGap = 8, .childAlignment = { .y = CLAY_ALIGN_Y_CENTER } }, .backgroundColor = {130, 130, 255, 255} }) {
                ...
                CLAY_TEXT(profileText, CLAY_TEXT_CONFIG({ .textColor = {0, 0, 0, 255}, .fontSize = 24, .textAlignment = CLAY_TEXT_ALIGN_RIGHT }));
            }
        ...
        CLAY(CLAY_ID("RightPanel"), { .layout = { .sizing = { .width = CLAY_SIZING_GROW(0), .height = CLAY_SIZING_GROW(0) }, .childGap = 16, .layoutDirection = CLAY_TOP_TO_BOTTOM }}) {
            ...
            })
            {
                 CLAY(CLAY_ID("FloatingContainer"), {
                     ...
                     .border = { .color = {80, 80, 80, 255}, .width = CLAY_BORDER_OUTSIDE(2) },
                 }) {
                 ...
                 CLAY_TEXT(CLAY_STRING("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt."),
                     CLAY_TEXT_CONFIG({ .textColor = {0,0,0,255}, .fontId = FONT_ID_BODY_24, .fontSize = 24 }));

                 CLAY(CLAY_ID("Photos2"), { .layout = { .padding = { 16, 16, 16, 16 }, .childGap = 16}, .backgroundColor = {180, 180, 220, Clay_Hovered() ? 120.0f : 255.0f} }) {
